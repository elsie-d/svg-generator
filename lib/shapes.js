  ...
  constructor(fillColor, txt, txtColor) {
   ...
   function generateShape(data){
    if(data.shape === Triangle){
      let reqShape = new Triangle (answers.fillColor, answers.txt, answers.txtColor)
      return reqShape.render()
    }
    if(data.shape === Circle){
      let reqShape = new Circle (answers.fillColor, answers.txt, answers.txtColor)
      return reqShape.render()
    }
    if(data.shape === Square){
      let reqShape = new Square (answers.fillColor, answers.txt, answers.txtColor)
      return reqShape.render()
    }
   }
