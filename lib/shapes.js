...
<text x="100" y="185" font-size="50" text-anchor="middle" fill="${this.txtColor}">${this.txt}</text></svg>`
  };
...
<text  x="150" y="130"  font-size="70" text-anchor="middle" fill="${this.txtColor}">${this.txt}</text></svg>`
   } 
 }
...
<text x="150" y="130"  font-size="70" text-anchor="middle" fill="${this.txtColor}">${this.txt}</text></svg>`
 ...
 // Export object
module.exports = { Shapes, Circle, Square, Triangle, generateSVG }